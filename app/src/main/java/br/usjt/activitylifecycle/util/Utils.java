package br.usjt.activitylifecycle.util;
...
public class Utils {
    ...
    private static br.usjt.activitylifecycle.util.StatusTracker mStatusTracker = br.usjt.activitylifecycle.util.StatusTracker.getInstance();
